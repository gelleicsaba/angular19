...
var VERSION = new Version("19.0.0-next.9");
...
var ViewContext = class {
  ...
  static {
    this.__NG_ELEMENT_ID__ = injectViewContext;
  }
};
...
var BASE_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, REACTIVE_NODE), {
  ...
  run() {
    ...
    try {
      ...
      this.injector.get(ErrorHandler, null, {
        optional: true
      })?.handleError(err);
    } finally {
...
var AfterRenderEffectSequence = class extends AfterRenderSequence {
  constructor(impl, effectHooks, scheduler, destroyRef) {
    ...
    this.scheduler = scheduler;
    this.lastPhase = null;
    this.nodes = [void 0, void 0, void 0, void 0];
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ELSQWQ5X.js.map
